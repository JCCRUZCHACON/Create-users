...
const FormUser = ({createUser,userSelected,
    setUserSelected,
    updateUser, setFormIsOpen, formIsOpen}) => {
  ...
  return (
    <div className={`form__container flex-container ${formIsOpen || 'form__close'}`}>
        <form onSubmit={handleSubmit(submit)} className="form flex-container">
            <span className="form__exit flex-container " onClick={handleExit}><i class='bx bx-x'></i>
            </span>
            ...
            <label className='form__field grid-container'>
                ...
                <input className={`form__input ${errors.email ? 'form__input--error' : ''}`} type="email" {...register('email',{maxLength:{value:50,
            ...
            <label className='form__field grid-container'>
                ...
                <input className={`form__input ${errors.password ? 'form__input--error' : ''}`} type="password" {...register('password',{maxLength:{value:20,
            ...
            <label className='form__field grid-container'>
                ...
                <input className={`form__input ${errors.first_name ? 'form__input--error' : ''}`} type="text" {...register('first_name',{maxLength:{value:15,
            ...
            <label className='form__field grid-container'>
                ...
                <input className={`form__input ${errors.last_name ? 'form__input--error' : ''}`} type="text" {...register('last_name',{maxLength:{value:15,
                    message:'The maximum number of characters is 15'},
                    required:'This field is required',                
                    })}
                    />
            ...
            <label className='form__field grid-container'>
                ...
                <input className={`form__input ${errors.birthday ? 'form__input--error' : ''}`} type="date" {...register('birthday',{maxLength:{value:10,
